...
const sharp = require('sharp'); //image resize or crop images
const fs = require('fs');
...
// add product
  ...
  const getProductManagement = asyncHandler(async (req, res) => {
    ...
    console.log(product)
      ...
      res.render("admin/productManagement",{product,message:''});
    });
    ...
    try {
        ...
        if (req.body.deletedImages) {
            ...
            deletedImages.forEach(image => {
                const imagePath = path.join(__dirname, '../public/assets/imgs/productIMG', image);
