...
const invoiceControlller = require("../controller/user/invoiceController");
...
userRoute.get(
  ...
  isLoggedin,
  isBlocked,
  userController.renderUserOrders
);
...
userRoute.get(
  ...
  isBlocked,
  isLoggedin,
  addressController.renderUserAddress
);
userRoute.get(
  "/editaddress",
  isBlocked,
  isLoggedin,
  addressController.renderEditUserAddress
);
userRoute.get(
  "/addaddress",
  isBlocked,
  isLoggedin,
  addressController.renderAddUserAddress
);
userRoute.post(
  "/addaddress",
  isBlocked,
...
//invoice
userRoute.get("/download-invoice/:id", invoiceControlller.downloadInvoice);
...
userRoute.get(
  "/currentpassword",
  changePasswordController.getCurrentPasswordPage
);
...
//wishlist management
userRoute.get("/wishlist",isBlocked, isLoggedin, wishlistController.getWishlist);
userRoute.post("/addtowishlist",isBlocked, isLoggedin, wishlistController.addtoWishlist);
userRoute.post(
  "/removefromwishlist",
